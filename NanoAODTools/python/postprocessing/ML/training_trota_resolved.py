...
best_hps_file = '%s/src/PhysicsTools/NanoAODTools/python/postprocessing/TROTA'+year+'/trainings/grid_search_trota_resolved_'+label+'/best_hps_'+label+'.json' % os.environ['CMSSW_BASE']
# best_hps_file = 
